...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="<?= base_url('admin/add_announcement') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" name="title" id="title" class="form-control mb-3" placeholder="Judul Pengumuman" autocomplete="off" required>
                                <!-- Kategori pengumuman -->
                                <div class="form-group">
                                    <label for="id_category" class="pl-1">Kategori Pengumuman</label>
                                    <select name="id_category" id="id_category" class=" " style="width: 100%;" required>
