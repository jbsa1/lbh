...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="<?= base_url('admin/edit_post') ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="text" name="title" id="title" class="form-control mb-3" placeholder="Judul Post" value="<?= $post['title'] ?>" autocomplete="off" required>
                                <!-- Isi -->
                                <label for="content" class="pl-1">Isi Postingan</label>
                                <textarea name="content" id="content" class="editor w-100"><?= $post['content'] ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="thumbnails" class="d-block">
                                    <img src="<?= ($post['thumbnail'] != NULL) ? base_url('assets/img/thumbnails/') . $post['thumbnail'] : base_url('assets/img/nophoto.png') ?>" id="thumbnail-show" alt="thumbnail" class="w-100" style="cursor: pointer;">
                                </label>
                                ...
                                <textarea name="description" id="description" class="form-control mb-3" placeholder="Dekripsi Post" required><?= $post['description'] ?></textarea>
                                <!-- Kategori -->
                                ...
                                <?php if ($post_cat != '') : ?>
                                    <script type='text/javascript'>
                                        var category = [<?= $post_cat ?>];
                                        $('#category').val([<?= $post_cat ?>]);
                                    </script>
                                <?php endif; ?>
                                <!-- ID Post -->
